        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="panel-head">
                    <div class="panel-title">Bạn đang muốn xóa tài khoản nhân viên: {{ $employees->fullname }} có email: {{ $employees->email }}</div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="fullName" value="{{ $employees->fullname }}" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Email: <span class="text-danger">(*)</span></label>
                                    <input type="text" name="email" value="{{ $employees->email }}" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
