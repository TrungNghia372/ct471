...
<form action="{{ route('management.insertEmployee') }}" class="box" method="post">
    @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-4">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="gender" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Số CCCD: <span class="text-danger">(*)</span></label>
                                    <input type="text" name="national_id" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <div class="form-row">
                                    ...
                                    <input type="date" name="date" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Ngày bắt đầu làm việc: <span class="text-danger">(*)</span></label>
                                    <input type="date" name="hire_date" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Mức lương: <span class="text-danger">(*)</span></label>
                                    <input type="number" name="salary" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="ward" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Quận/Huyện: <span class="text-danger">(*)</span></label>
                                    <input type="text" name="district" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Tỉnh/Thành phố: <span class="text-danger">(*)</span></label>
                                    <input type="text" name="province" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
