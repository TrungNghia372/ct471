...
<form action="{{ route('management.insertService') }}" class="box" method="post">
    @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="service_name" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-right">Giá: <span class="text-danger">(*)</span></label>
                                    <input type="number" name="service_price" value="" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row">
