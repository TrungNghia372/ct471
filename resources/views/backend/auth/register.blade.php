        ...
        <div class="col-6">
            <form method="post" role="form" action="{{ route('auth.doRegister') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Nhập email" name="emailRegister" value="{{ old('emailRegister') }}"/>
                    @if ($errors->has('emailRegister'))
                        <span class="error-message">* {{ $errors->first('emailRegister') }}</span>
                    @endif
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" class="form-control" placeholder="Nhập mật khẩu" name="passwordRegister2"/>
